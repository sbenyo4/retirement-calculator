...
export function ModelsManager({ apiKeys, onClose, onModelsUpdated, t }) {
...
function ProviderResults({ providerId, data, isLight, t, selectedModels, onToggleModel, onSelectAll, onDeselectAll }) {
